...
const Faq = ({ questions }) => {
  return (
    ...
    <div className="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 mb-24 rounded-2xl ">
      <h1 className="text-3xl mt-0 mb-12 font-bold text-center text-base-300">
