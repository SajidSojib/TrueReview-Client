...
const Navbar = () => { 
  ...
  return (
      <div className="px-4 py-3 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-warning">
                    ...
                    <ul className="pt-4 pb-2 space-y-1 text-sm">
                      {user ? (
                        <li onClick={handleLogOut}>
                          <button className="flex btn btn-primary w-full text-error">
                            Log Out
                          </button>
                        </li>
                      ) : (
                        <div className="flex items-center justify-around">
                          ...
                          <li>
                            <Link
                              ...
                              aria-label="Register"
                              title="Register"
                              className="flex btn btn-primary text-error"
                            >
                              Register
                            </Link>
                          </li>
